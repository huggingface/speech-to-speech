...
MODEL_CASES: tuple[ModelCase, ...] = (
    ...
    ModelCase(
        name="password_habit_no_tool",
        user_prompt="I keep forgetting my passwords. What should I do?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="weak_wifi_no_tool",
        user_prompt="My Wi-Fi is much worse in the bedroom than the living room. Why?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="overwatered_basil_no_tool",
        user_prompt="I overwatered my basil yesterday. Can it still recover?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="cold_battery_no_tool",
        user_prompt="Why does my laptop battery drain faster when it is cold outside?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="echoey_calls_no_tool",
        user_prompt="My apartment sounds echoey on calls. What is an easy fix?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="presentation_nerves_no_tool",
        user_prompt="I get nervous right before presentations. What can I do in the moment?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="phone_hot_maps_no_tool",
        user_prompt="My phone gets hot when I use maps in the car. Is that normal?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="ripe_avocado_no_tool",
        user_prompt="How can I tell if an avocado is ripe?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="sourdough_rise_no_tool",
        user_prompt="What makes sourdough bread rise?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="rainbow_no_tool",
        user_prompt="Why do rainbows form?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="damp_laundry_no_tool",
        user_prompt="My clean laundry smells damp after drying. What should I change?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="bike_tire_no_tool",
        user_prompt="My bike tire keeps losing air slowly. What should I check first?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
    ModelCase(
        name="sticky_rice_no_tool",
        user_prompt="My rice keeps coming out too sticky. What should I change?",
        max_sentences=2,
        max_words=64,
        tools=(LOOKUP_TOOL,),
    ),
